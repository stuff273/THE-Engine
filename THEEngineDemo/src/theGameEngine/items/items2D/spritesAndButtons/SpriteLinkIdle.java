...
public class SpriteLinkIdle extends Sprite{

	public SpriteLinkIdle(float screenCenterX, float screenCenterY, Controller2D controller2d) 
	{
		super(screenCenterX, screenCenterY, ModelSet2DFourSwords.link, controller2d);
	}
